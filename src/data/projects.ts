...
export const INITIAL_PROJECTS: Project[] = [
  ...
  { slug:'makiva', name:'Makiva.work', description:'Prototype. Currently houses no meaningful product functionality.', category:'Experiment', status:'Prototype', url:null, domain:null },
  ...
  { slug:'spacia', name:'Spacia', description:'Experiment.', category:'Experiment', status:'Beta / Experiment', url:null, domain:null },
  { slug:'dieselguard', name:'DieselGuard', description:'Experiment.', category:'Experiment', status:'Experiment', url:null, domain:null },
