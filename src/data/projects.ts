...
export const INITIAL_PROJECTS: Project[] = [
  ...
  { slug:'notify', name:'Notify.i.ng', description:'Announce a passing. Honour a life. In 60 seconds. Digital memorials, funeral arrangement flyers, community tribute books, and condolence support for Nigerian families.', category:'Product', status:'Active / Product', url:'https://notify.i.ng', domain:'notify.i.ng' },
  ...
  { slug:'oga-at-dtop', name:'OGA@DTOP', description:'What should exist in Nigeria? Anonymous civic suggestion and complaint board. Broadcast rants, ideas, and infrastructure solutions directly to builders.', category:'Product', status:'Live', url:'https://ogaatthe.top', domain:'ogaatthe.top' },
